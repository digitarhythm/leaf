...
const SHORTCUTS: &[ShortcutRow] = &[
    ...
    ShortcutRow { key: "Opt/Alt + l",       action_ja: "フル画面プレビュー（Web）/ タブ選択プレビュー（Desktop）", action_en: "Full Preview (Web) / Tab Preview (Desktop)" },
    ShortcutRow { key: "Opt/Alt + e",       action_ja: "分割プレビュー / 右ペイン編集モード切り替え", action_en: "Split Preview / Toggle Edit Mode in Split" },
