                    ...
                    <div class="px-6 py-4 bg-gray-900/50 border-t border-gray-800 flex flex-col items-center space-y-4 relative">
                        ...
                        if props.is_help {
                            <div class="flex items-center space-x-6 text-xs text-gray-500">
                                <a href={if matches!(lang, Language::Ja) { "assets/html/about_ja.html".to_string() } else { "assets/html/about.html".to_string() }} target="_blank" class="hover:text-emerald-400 transition-colors underline underline-offset-4 decoration-gray-700">{ i18n::t("about", lang) }</a>
                                <a href="assets/html/terms.html" target="_blank" class="hover:text-emerald-400 transition-colors underline underline-offset-4 decoration-gray-700">{ i18n::t("terms_of_service", lang) }</a>
                                <a href="assets/html/privacy.html" target="_blank" class="hover:text-emerald-400 transition-colors underline underline-offset-4 decoration-gray-700">{ i18n::t("privacy_policy", lang) }</a>
                                <a href="assets/html/licenses.html" target="_blank" class="hover:text-emerald-400 transition-colors underline underline-offset-4 decoration-gray-700">{ i18n::t("oss_licenses", lang) }</a>
                            </div>
                        }
                    </div>
                }
